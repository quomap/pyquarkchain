...
class RootState:
    ...
    def coinbase_with_tax(self, m_hash_list: List[bytes]):
        """
    ...
    def create_block_to_mine(self, m_header_list, address=None, create_time=None):
        ...
        return block.finalize(
            coinbase_amount=self.coinbase_with_tax(
